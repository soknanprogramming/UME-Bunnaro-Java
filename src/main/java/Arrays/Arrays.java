    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(btn, javax.swing.GroupLayout.PREFERRED_SIZE, 188, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(101, 101, 101))
        );
...
//        arrValue[1] = 5;
//        arrValue[2] = 1;
        int[] arrValue = {2, 5, 1, 0, 2};
        String showResult = "";
        for(int i = 0; i < arrValue.length; i++){
            showResult = showResult + "Index is " + i + " Value is " + arrValue[i] + "\n";
        }
        
        JOptionPane.showMessageDialog(rootPane, showResult);
